...
plot(x=area.med, y=res$climRr, main="SEM path values", type = "o", col="black", ylim=c(-1.4,0.5), xlab="Scale")
lines(area.med, res$climLr, type="o", col="red")
lines(area.med, y=res$RrLr, type="o", col="blue")
legend("bottom", legend= c("Clim -> Rrich", "Clim -> Lrich", "Rrich -> Lrich"), col=c("black", "red", "blue"), lty=1, lwd=2, cex = 0.7, bty = "n", text.width=1)
...
>>>>>>> e13e2ac753eb1279907904206f4c07c3308e354f
