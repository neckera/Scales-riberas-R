...
setwd("/home/indra/Dropbox/carpeta sin titulo/results.CCC/")
ori.par <- par()
```
...
DESIGN FUNCTION: how much data do we have for each pool?
```{r}
...
EXECUTE FUNCTION: how much data do we have for each pool?
```{r}
# BASINS
...
write.table(puse.bas, "/home/indra/Dropbox/carpeta sin titulo/results.local/peval.bas.csv", sep=";", quote = F, row.names = T)
...
write.table(puse.geo, "/home/indra/Dropbox/carpeta sin titulo/results.local/peval.geo.csv", sep=";", quote = F, row.names = T)
...
write.table(puse.cos, "/home/indra/Dropbox/carpeta sin titulo/results.local/peval.cos.csv", sep=";", quote = F, row.names = T)
```

PLOT: how much data do we have for each pool?
```{r}
par(mfrow=c(1,1))
...
PLOT: which pools have less than 3 inventarios
```{r}
scale <- 6
par(mar=c(0,0,3,0))
