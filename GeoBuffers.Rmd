...
sc<-readOGR(dsn = "/Users/marialeomontes/Documents/BIOLOGIA/ARTICULOS/Local_Regional/Datos/GIS", layer="Subcuenca_c_800")
...
# aa <- sapply(scs, function(x){sapply(x@polygons, function(y){y@Polygons[[1]]@area})})
...
pdist <- lapply(seq_along(1:nrow(coorinvt)), function(x){spDistsN1(coorclim, as.numeric(coorinvt[x,]), longlat=T)})
